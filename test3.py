...
candidate_labels = [
    "Waste Management / Public Cleanliness", "Education", "Healthcare", "Housing",
    "Transportation", "Environment", "Economy", "Crime", "Community Services",
    "Technology", "Infrastructure", "Public Safety"
]
